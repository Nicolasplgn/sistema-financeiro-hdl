...
export const CardHeader = ({ title, subtitle, icon: Icon, action }) => (
  <div className="flex justify-between items-start mb-6">
    <div>
      {Icon && (
        <div className="flex items-center gap-2 mb-2 text-blue-600 font-black text-[9px] tracking-[0.2em] uppercase">
          <Icon size={14} />
          <span>Módulo</span>
        </div>
      )}
      <h3 className="text-sm font-black text-slate-900 tracking-tight italic">{title}</h3>
